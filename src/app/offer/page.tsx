          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-3xl p-8 md:p-12 shadow-xl mb-16 text-left">
              ...
              <ul className="space-y-6">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900">High-Ticket Focus</h3>
                    <p className="text-slate-600 mt-1">We optimize campaigns exclusively for AC replacements, furnace installs, and high-margin repairs. No low-end service calls.</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="bg-green-100 p-2 rounded-lg mt-1 text-green-600"><CheckCircle2 className="w-6 h-6"/></div>
                  <div>
                    ...
                    <p className="text-slate-600 mt-1">Your leads are never sold to competitors. Once they enter your funnel, they are yours and yours alone.</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="bg-green-100 p-2 rounded-lg mt-1 text-green-600"><CheckCircle2 className="w-6 h-6"/></div>
                  <div>
                    ...
                    <p className="text-slate-600 mt-1">Our AI calling system verifies the homeowner's intent and urgency before injecting the appointment straight into your calendar.</p>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
              <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm text-center">
                ...
                <p className="text-sm text-slate-600 mt-2">Zero retainer risks. We are purely incentivized by your growth.</p>
              </div>
              <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm text-center">
                <ShieldCheck className="w-10 h-10 text-[#ff6a00] mx-auto mb-4" />
                <h4 className="font-bold text-slate-900">Ironclad Guarantee</h4>
                <p className="text-sm text-slate-600 mt-2">If we don't deliver 20 booked jobs in 90 days, we refund our fee.</p>
              </div>
              <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm text-center">
                <Clock className="w-10 h-10 text-primary-light mx-auto mb-4" />
                <h4 className="font-bold text-slate-900">Rapid Launch</h4>
                <p className="text-sm text-slate-600 mt-2">Your system goes live and starts generating calls within 7 days.</p>
              </div>
            </div>
            ...
            <p className="text-center text-sm text-slate-500 mt-4">We strictly partner with ONE contractor per 50-mile radius.</p>
          </div>
        </section>
      </main>
